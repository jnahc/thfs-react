  ...
  return (
    <div className="container">
      ...
      <dl>
        ...
        <dd>Main Picture <img src={props.castDetails.mainPicture}/> </dd>
        <dd>Picture 1 <img src={props.castDetails.picture1}/> </dd>
        <dd>Picture 2 <img src={props.castDetails.picture2}/> </dd>
      </dl>
